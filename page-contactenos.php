            ...
            <div class="col">
                ...
                <div class="col alignBtn">
                    <?php
                        ...
                        echo "<a class='buttons' href='./contactenos-ventas'>".$form1_btn."</a>";
                     ?>
                </div>
            ...
            <div class="col">
                ...
                <div class="col alignBtn">
                    <?php
                        ...
                        echo "<a class='buttons' href='./contactenos-comida-info'>".$form2_btn."</a>";
                     ?>
                </div>
            ...
            <div class="col">
                ...
                <div class="col alignBtn">
                    <?php
                        ...
                        echo "<a class='buttons' href='./contactenos-preguntas'>".$form3_btn."</a>";
                     ?>
                </div>
